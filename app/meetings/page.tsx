...
import { archiveMeetings, nextMeeting } from "@/lib/meetings";
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="mx-auto w-full max-w-6xl flex-1 px-4 md:px-6">
        ...
        <section className="py-10 lg:py-16">
          <Reveal>
            <SectionLabel>
              {t("meetings.archive")} — 24 {t("meetings.meeting")}
            </SectionLabel>
          </Reveal>
          ...
          <Reveal delay={200}>
            <div className="mt-8 text-center">
              <Button variant="outline" href="/meetings">
                {t("meetings.all")}
              </Button>
            </div>
          </Reveal>
